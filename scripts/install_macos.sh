#!/usr/bin/env bash
# ==============================================================================
# Kapsel - Modern Cross-Platform Terminal Capsule Installer for macOS
...
#
# Usage:
#   curl -fsSL https://raw.githubusercontent.com/MrEiu/Kapsel/master/scripts/install_macos.sh | bash
